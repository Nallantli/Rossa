...
namespace ops
{
	inline const sym_t index(const scope_t *scope, const sym_t &evalA, const sym_t &evalB, const token_t *token, trace_t &stack_trace)
	{
	...
	inline const sym_t call(const scope_t *scope, const i_ptr_t &a, const sym_vec_t &args, const token_t *token, trace_t &stack_trace)
	{
		switch (a->getType()) {
	...
	inline const sym_t untilstep(const scope_t *scope, const bool &inclusive, const sym_t &evalA, const sym_t &evalB, const sym_t &step, const token_t *token, trace_t &stack_trace)
	{
		switch (COMP(evalA.getValueType(), evalB.getValueType())) {
	...
	inline const sym_t untilnostep(const scope_t *scope, const bool &inclusive, const sym_t &evalA, const sym_t &evalB, const token_t *token, trace_t &stack_trace)
	{
		switch (COMP(evalA.getValueType(), evalB.getValueType())) {
			case COMP(Value::NUMBER, Value::NUMBER):
			{
	...
	inline const sym_t add(const scope_t *scope, const sym_t &evalA, const sym_t &evalB, const token_t *token, trace_t &stack_trace)
	{
		switch (COMP(evalA.getValueType(), evalB.getValueType())) {
			case COMP(Value::NUMBER, Value::NUMBER):
	...
	inline const sym_t sub(const scope_t *scope, const sym_t &evalA, const sym_t &evalB, const token_t *token, trace_t &stack_trace)
	{
		switch (COMP(evalA.getValueType(), evalB.getValueType())) {
			case COMP(Value::NUMBER, Value::NUMBER):
				return sym_t::Number(evalA.getNumber(token, stack_trace) - evalB.getNumber(token, stack_trace));
	...
	inline const sym_t mul(const scope_t *scope, const sym_t &evalA, const sym_t &evalB, const token_t *token, trace_t &stack_trace)
	{
		switch (COMP(evalA.getValueType(), evalB.getValueType())) {
			case COMP(Value::NUMBER, Value::NUMBER):
				return sym_t::Number(evalA.getNumber(token, stack_trace) * evalB.getNumber(token, stack_trace));
	...
	inline const sym_t div(const scope_t *scope, const sym_t &evalA, const sym_t &evalB, const token_t *token, trace_t &stack_trace)
	{
		switch (COMP(evalA.getValueType(), evalB.getValueType())) {
			case COMP(Value::NUMBER, Value::NUMBER):
				return sym_t::Number(evalA.getNumber(token, stack_trace) / evalB.getNumber(token, stack_trace));
	...
	inline const sym_t mod(const scope_t *scope, const sym_t &evalA, const sym_t &evalB, const token_t *token, trace_t &stack_trace)
	{
		switch (COMP(evalA.getValueType(), evalB.getValueType())) {
			case COMP(Value::NUMBER, Value::NUMBER):
				return sym_t::Number(evalA.getNumber(token, stack_trace) % evalB.getNumber(token, stack_trace));
	...
	inline const sym_t pow(const scope_t *scope, const sym_t &evalA, const sym_t &evalB, const token_t *token, trace_t &stack_trace)
	{
		switch (COMP(evalA.getValueType(), evalB.getValueType())) {
			case COMP(Value::NUMBER, Value::NUMBER):
	...
	inline const sym_t less(const scope_t *scope, const sym_t &evalA, const sym_t &evalB, const token_t *token, trace_t &stack_trace)
	{
		switch (COMP(evalA.getValueType(), evalB.getValueType())) {
			case COMP(Value::NUMBER, Value::NUMBER):
	...
	inline const sym_t more(const scope_t *scope, const sym_t &evalA, const sym_t &evalB, const token_t *token, trace_t &stack_trace)
	{
		switch (COMP(evalA.getValueType(), evalB.getValueType())) {
			case COMP(Value::NUMBER, Value::NUMBER):
				return sym_t::Boolean(evalA.getNumber(token, stack_trace) > evalB.getNumber(token, stack_trace));
	...
	inline const sym_t eless(const scope_t *scope, const sym_t &evalA, const sym_t &evalB, const token_t *token, trace_t &stack_trace)
	{
		switch (COMP(evalA.getValueType(), evalB.getValueType())) {
			case COMP(Value::NUMBER, Value::NUMBER):
				return sym_t::Boolean(evalA.getNumber(token, stack_trace) <= evalB.getNumber(token, stack_trace));
	...
	inline const sym_t emore(const scope_t *scope, const sym_t &evalA, const sym_t &evalB, const token_t *token, trace_t &stack_trace)
	{
		switch (COMP(evalA.getValueType(), evalB.getValueType())) {
			case COMP(Value::NUMBER, Value::NUMBER):
				return sym_t::Boolean(evalA.getNumber(token, stack_trace) >= evalB.getNumber(token, stack_trace));
	...
	inline const sym_t bor(const scope_t *scope, const sym_t &evalA, const sym_t &evalB, const token_t *token, trace_t &stack_trace)
	{
		switch (COMP(evalA.getValueType(), evalB.getValueType())) {
			case COMP(Value::NUMBER, Value::NUMBER):
				return sym_t::Number(evalA.getNumber(token, stack_trace) | evalB.getNumber(token, stack_trace));
	...
	inline const sym_t bxor(const scope_t *scope, const sym_t &evalA, const sym_t &evalB, const token_t *token, trace_t &stack_trace)
	{
		switch (COMP(evalA.getValueType(), evalB.getValueType())) {
			case COMP(Value::NUMBER, Value::NUMBER):
				return sym_t::Number(evalA.getNumber(token, stack_trace) ^ evalB.getNumber(token, stack_trace));
	...
	inline const sym_t band(const scope_t *scope, const sym_t &evalA, const sym_t &evalB, const token_t *token, trace_t &stack_trace)
	{
		switch (COMP(evalA.getValueType(), evalB.getValueType())) {
			case COMP(Value::NUMBER, Value::NUMBER):
				return sym_t::Number(evalA.getNumber(token, stack_trace) & evalB.getNumber(token, stack_trace));
	...
	inline const sym_t bshl(const scope_t *scope, const sym_t &evalA, const sym_t &evalB, const token_t *token, trace_t &stack_trace)
	{
		switch (COMP(evalA.getValueType(), evalB.getValueType())) {
			case COMP(Value::NUMBER, Value::NUMBER):
				return sym_t::Number(evalA.getNumber(token, stack_trace) << evalB.getNumber(token, stack_trace));
	...
	inline const sym_t bshr(const scope_t *scope, const sym_t &evalA, const sym_t &evalB, const token_t *token, trace_t &stack_trace)
	{
		switch (COMP(evalA.getValueType(), evalB.getValueType())) {
			case COMP(Value::NUMBER, Value::NUMBER):
				return sym_t::Number(evalA.getNumber(token, stack_trace) >> evalB.getNumber(token, stack_trace));
	...
	inline const sym_t bnot(const scope_t *scope, const sym_t &evalA, const token_t *token, trace_t &stack_trace)
	{
	...
	inline const sym_t unadd(const scope_t *scope, const sym_t &evalA, const token_t *token, trace_t &stack_trace)
	{
		switch (evalA.getValueType()) {
			case Value::type_t::NUMBER:
				return sym_t::Number(+evalA.getNumber(token, stack_trace));
	...
	inline const sym_t neg(const scope_t *scope, const sym_t &evalA, const token_t *token, trace_t &stack_trace)
	{
		switch (evalA.getValueType()) {
			case Value::type_t::NUMBER:
				return sym_t::Number(-evalA.getNumber(token, stack_trace));
	...
	inline const sym_t unot(const scope_t *scope, const sym_t &evalA, const token_t *token, trace_t &stack_trace)
	{
		switch (evalA.getValueType()) {
	...
	inline const sym_t cct(const scope_t *scope, const sym_t &evalA, const sym_t &evalB, const token_t *token, trace_t &stack_trace)
	{
		switch (COMP(evalA.getValueType(), evalB.getValueType())) {
			case COMP(Value::ARRAY, Value::ARRAY):
			{
	...
	inline const sym_t del(const scope_t *scope, const sym_t &evalA, const sym_t &evalB, const token_t *token, trace_t &stack_trace)
	{
		switch (COMP(evalA.getValueType(), evalB.getValueType())) {
			case COMP(Value::DICTIONARY, Value::STRING):
			{
	...
	inline const sym_t hash(const scope_t *scope, const sym_t &evalA, const token_t *token, trace_t &stack_trace)
	{
