...
#define _FAILURE_ALLOC_ "Cannot initialize a Array with size < 0"
#define _FAILURE_TO_STR_ "Cannot convert values into String"
#define _FAILURE_STRING_FORMAT_ "Elements to be parsed remain in String"
...
#define _NOT_VECTOR_ "Value is not of type `Array`"
...
#define _FAILURE_ALLOC_ "Non si può creare un Vettore [Array] colla lunghezza meno di 0"
#define _FAILURE_TO_STR_ "Non si può convertire i valori in una Stringa [String]"
#define _FAILURE_STRING_FORMAT_ "Ci sono parti rimanenti per analisi nella Stringa [String]"
...
#define _NOT_VECTOR_ "Il tipo di valore non è `Vettore` [Array]"
...
#define _FILE_NOT_FOUND_ "Scapus qui `%1%` nominator non inveniri poterat"
...
#define _FAILURE_ALLOC_ "Tabula [Array] cum magnitudone < 0 non creari potest"
#define _FAILURE_TO_STR_ "Valores in Seriem [String] mutari non possunt"
#define _FAILURE_STRING_FORMAT_ "In Serie [String] manent pro computationem incompletas adhuc partes"
...
#define _NOT_VECTOR_ "Cum genere `Tabula` [Array] non declaratur valor"
...
#define _FAILURE_ALLOC_ "ゼロ以下の長さの同意列（Array）は駄目"
#define _FAILURE_TO_STR_ "値は文字列の変換は駄目"
#define _FAILURE_STRING_FORMAT_ "「文字列」（String）の解析についてまだ部分が残っている"
...
#define _NOT_VECTOR_ "値の種類は「同意列」（Array）ではない"
